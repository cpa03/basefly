...
- Enhanced SECURITY.md with supported versions, severity levels/SLAs, and vulnerability report template
- Enhanced CONTRIBUTING.md with branch naming conventions, commit message guidelines, and security cross-links
