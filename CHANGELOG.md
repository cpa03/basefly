...
- Corrected rollback guide Automation section: removed false claim that `.github/workflows/release.yml` exists; documented actual release tooling (`scripts/release-tag.mjs` via `pnpm release:tag` + `docs/release-process.md`)
