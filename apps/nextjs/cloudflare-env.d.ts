/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f27d82eaef99e2a82deaa2dbcf1e35ef)
// Runtime types generated with workerd@1.20260219.0 2026-02-18 global_fetch_strictly_public,nodejs_compat,nodejs_compat_v2
declare namespace Cloudflare {
  ...
  interface Env {
    ASSETS?: Fetcher;
    NODE_VERSION?: "20";
    WORKER_SELF_REFERENCE?: Fetcher /* basefly */;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "NODE_VERSION">
  > {}
}
declare module "*.wasm" {
