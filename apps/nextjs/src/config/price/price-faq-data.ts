...
function generateFAQAnswers(locale: "en" | "zh" | "ja" | "ko"): {
  ...
  switch (locale) {
    case "zh":
      return {
        freePlanCost: "我们的免费计划完全免费，没有月费或年费。这是一个开始使用和探索我们基本功能的好方法。",
        ...
        trialPeriod: "我们为专业月度和专业年度计划提供14天的免费试用期。这是一个在承诺付费订阅之前体验所有功能的好方法。",
      };
    case "ja":
      return {
        freePlanCost: "私たちの無料プランは完全に無料で、月額料金や年間料金はかかりません。基本的な機能を使い始めるには最適な方法です。",
        ...
        trialPeriod: "プロ月額プランとプロ年間プランの両方に14日間の無料トライアルを提供しています。これは、有料サブスクリプションを行う前に全ての機能を体験するのに最適な方法です。",
      };
    case "ko":
      return {
        freePlanCost: "저희 물료 플랜은 완전히 물료이며, 월간 또는 연간 요금이 없습니다. 기본 기능을 시작하고 탐색하는 데 좋은 방법입니다.",
        ...
        trialPeriod: "저희는 프로 월간 및 프로 연간 플랜에 대해 14일 물료 체험 기간을 제공합니다. 유료 구독을 하기 전에 모든 기능을 경험할 수 있는 좋은 방법입니다.",
      };
    default: // en
      return {
        freePlanCost: "Our free plan is completely free, with no monthly or annual charges. It's a great way to get started and explore our basic features.",
        ...
        trialPeriod: "We offer a 14-day free trial for both the Pro Monthly and Pro Annual plans. It's a great way to experience all the features before committing to a paid subscription.",
      };
  }
}
