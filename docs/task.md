...
- [CONSOLIDATE] Centralized Sheet component styling and tokens under SHEET_TOKENS inside @saasfly/common/src/ui-tokens.ts
- [STRENGTHEN] Enhanced Sheet close button with tactile spring scale micro-interactions (hover:scale-110 active:scale-95) and updated unit tests
