 ...
 * Centralized layout, styling, sub-component classes, micro-interactions, and accessibility for Calendar component
 */
export const CALENDAR_TOKENS = {
  /** Root container layout */
  base: "p-3",

  /** Sub-component layout and element class names */
  classNames: {
    ...
    nav_button:
      "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-all duration-200 ease-out hover:scale-110 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    nav_button_previous: "absolute left-1",
    nav_button_next: "absolute right-1",
    button_previous:
      "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-all duration-200 ease-out hover:scale-110 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 absolute left-1",
    button_next:
      "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-all duration-200 ease-out hover:scale-110 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 absolute right-1",
    ...
    day: "h-9 w-9 p-0 font-normal aria-selected:opacity-100 transition-all duration-200 ease-out hover:scale-[1.05] active:scale-[0.95] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    day_button:
      "h-9 w-9 p-0 font-normal aria-selected:opacity-100 transition-all duration-200 ease-out hover:scale-[1.05] active:scale-[0.95] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    day_selected:
  ...
  /** Default fallback aria labels */
  defaultPrevAriaLabel: "Previous month",
  defaultNextAriaLabel: "Next month",
  defaultAriaLabel: "Calendar date picker",
} as const;
