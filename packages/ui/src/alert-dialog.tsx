...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      aria-modal="true"
      aria-label={props["aria-label"] ?? ALERT_DIALOG_TOKENS.defaultAriaLabel}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn(ALERT_DIALOG_TOKENS.title.base, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn(ALERT_DIALOG_TOKENS.description.base, className)}
    {...props}
  />
));
