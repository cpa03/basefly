...
const AlertDialogPortal = ({
  ...
  <AlertDialogPrimitive.Portal {...props}>
    <div className={ALERT_DIALOG_TOKENS.portal}>{children}</div>
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(ALERT_DIALOG_TOKENS.overlay, className)}
    {...props}
    ref={ref}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      aria-modal="true"
      className={cn(ALERT_DIALOG_TOKENS.content, className)}
      {...props}
    />
  </AlertDialogPortal>
));
...
const AlertDialogHeader = ({
  ...
  <div className={cn(ALERT_DIALOG_TOKENS.header, className)} {...props} />
);
...
const AlertDialogFooter = ({
  ...
  <div className={cn(ALERT_DIALOG_TOKENS.footer, className)} {...props} />
);
